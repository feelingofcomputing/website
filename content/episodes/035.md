...
Unlike other website builders, Webflow decided from "day one" to "rely on browsers and open web standards to actually do the underlying work for us. That's the concept of building directly for the medium that we're creating for. We're not building our rendering engine or our own layout engine. We would really have to be _more right_ than the web platform for that to eventually succeed."
...
<iframe src="https://omny.fm/shows/feeling-of-computing/35-democratizing-web-design-vlad-magdalin/embed" width="100%" height="180" frameborder="0"></iframe>
